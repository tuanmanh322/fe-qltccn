...
import {CURRENT_USER, TOKEN} from "../model/qlttcn.constant";
...
export class AuthService {
  ...
  login(login: LoginModel): Observable<any> {
    ...
    return this.http.post(`${environment.api}/authenticate`, login, {observe: 'response'})
  ...
  getProfile() {
    return this.http.get(`${environment.api}/user/profile-user`);
  }
